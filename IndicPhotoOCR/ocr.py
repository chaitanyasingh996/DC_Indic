...
class OCR:
    ...
    def visualize_detection(self, image_path, detections, save_path=None, show=False):
        ...
        for box in detections:
            ...
            # Put text (centered)
            cv2.putText(image, str(id), (center_x, center_y),
    ...
    def crop_and_identify_script(self, image, bbox):
        ...
        if self.verbose:
            print("Identifying script for the cropped area... HI")
    ...
    def ocr(self, image_path):
        ...
        # save model image output
        save_path = "Model_Images"+image_path[22:]
        ...
        for id, bbox in enumerate(detections):
            ...
            if script_lang:
                ...
                recognized_texts[f"img_{id}"] = {"txt": recognized_text, "bbox": [x1, y1, x2, y2],"script_language":script_lang}

        # visualizing image
        self.visualize_detection(image_path, detections, save_path=save_path)
